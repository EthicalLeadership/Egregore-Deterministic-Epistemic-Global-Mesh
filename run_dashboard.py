...
os.environ.setdefault('BLACKSTAR_API_KEYS', api_key + ':test:admin:admin')
os.environ.setdefault('BLACKSTAR_ZARC_SIGNING_KEY_HEX', open('secrets/signing_key.pem').read().strip())
