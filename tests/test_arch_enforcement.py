...
ALLOWED_LAYER_DEPENDENCIES: dict[str, set[str]] = {
    "aegis_hive": {"cells"},
    "application": {"domain", "governance", "http_api", "infrastructure", "interface", "kernel", "models", "powertrain", "services", "shared"},
    "assurance": {"domain"},
    "bus": {},
    ...
    "dossiers": {},
    "dt1": {},
    "ems": {"domain", "infrastructure", "interface", "kernel", "shared"},
    "factory": {"domain", "shared"},
    "governance": {"infrastructure", "models", "shared"},
    "http_api": {"application", "domain", "ems", "governance", "infrastructure", "interface", "models", "rfe", "services", "shared"},
    "infrastructure": {"application", "domain", "interface", "kernel", "models", "shared"},
    "interface": {"application", "cells", "domain", "factory", "governance", "http_api", "infrastructure", "models", "rfe", "shared"},
    ...
    "services": {"application", "domain", "infrastructure", "interface", "kernel", "shared"},
    "shared": {"domain"},
